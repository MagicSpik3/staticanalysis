test_that("map_internal_calls detects function dependencies", {
...
test_that("map_internal_calls handles empty or missing files gracefully", {
  temp_dir <- withr::local_tempdir()
...
test_that("map_internal_calls ignores non-function items", {
  temp_dir <- withr::local_tempdir()
