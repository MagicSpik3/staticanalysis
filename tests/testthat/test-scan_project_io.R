test_that("scan_project_io correctly identifies READ operations", {
...
test_that("scan_project_io correctly identifies WRITE operations", {
  temp_dir <- withr::local_tempdir()
...
test_that("scan_project_io captures complex argument syntax EXACTLY", {
  temp_dir <- withr::local_tempdir()
...
test_that("scan_project_io handles empty or irrelevant files", {
  temp_dir <- withr::local_tempdir()
