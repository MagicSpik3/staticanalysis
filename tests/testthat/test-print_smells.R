...
test_that("print_smells handles clean code (empty input)", {
...
test_that("print_smells formats report correctly", {
  smells <- data.frame(
...
test_that("print_smells sorts critical issues to the top", {
  smells <- data.frame(
