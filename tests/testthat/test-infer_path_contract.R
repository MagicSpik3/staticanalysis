test_that("infer_path_contract detects INPUT roles from read functions", {
...
test_that("infer_path_contract detects OUTPUT roles from write functions", {
  temp_dir <- withr::local_tempdir()
...
test_that("infer_path_contract handles bracket notation paths[['key']]", {
...
test_that("infer_path_contract respects custom config variable names", {
  temp_dir <- withr::local_tempdir()
...
test_that("infer_path_contract returns unique rows for duplicate usage", {
  temp_dir <- withr::local_tempdir()
