test_that("staticanalysis:::check_growing_vectors detects basic quadratic growth pattern", {
...
test_that("staticanalysis:::check_growing_vectors detects growth in WHILE loops", {
...
test_that("staticanalysis:::check_growing_vectors ignores safe pre-allocation", {
...
test_that("staticanalysis:::check_growing_vectors ignores assignment to DIFFERENT variable", {
  # Scenario: y <- c(x, new)
...
test_that("staticanalysis:::check_growing_vectors handles assignments outside loops correctly", {
...
test_that("staticanalysis:::check_growing_vectors detects growing with complex expressions", {
