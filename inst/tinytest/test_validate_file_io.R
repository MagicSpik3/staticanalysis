# Test: validate_file_io approves existing literal files
...
# Test: validate_file_io catches missing literal files
...
# Test: validate_file_io resolves constructed paths using context
...
# Test: validate_file_io skips rows when context variable is missing
...
# Test: validate_file_io handles NULL/Empty input gracefully
