# Test: run_preflight_check passes when all files and directories exist
...
# Test: run_preflight_check fails on missing input file
  temp_dir <- withr::local_tempdir()
...
# Test: run_preflight_check fails on missing output directory
  temp_dir <- withr::local_tempdir()
...
# Test: run_preflight_check fails on placeholders in output paths
  temp_dir <- withr::local_tempdir()
...
# Test: run_preflight_check warns but passes if key is missing from paths
...
# Test: run_preflight_check handles NULL contract gracefully
